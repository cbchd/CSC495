...
public class LobbyRoom {
		...
		storyTimeService.getLobbyRoomInformation(new AsyncCallback<LobbyRoomData>() {
			...
			public void onSuccess(LobbyRoomData result) {
				...
				System.out.println("Client: Got Data: PointCap: " + roomData.pointCap + ", Name: " + roomData.roomName
						+ ", Theme: " + roomData.theme + ", " + "Timer: " + roomData.authorsTimer + ", Users: "
	...
	public void displayView() {
		...
		final ValueListBox<Integer> pointLimitBox = new ValueListBox<Integer>(IntegerRenderer.instance());
		...
		timePerRoundBox.setValue(roomData.authorsTimer);
		...
		theRemoteEventService.addListener(DomainFactory.getDomain(roomData.roomName), new RemoteEventListener() {
			...
			public void apply(Event anEvent) {
				if (anEvent instanceof UpdatePointLimitEvent) {
					...
					roomData.authorsTimer = updateSubmissionTimerEvent.authorsTimer;
