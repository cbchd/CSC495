...
public class GameInProgressRoomPresenter implements Presenter {
	
	private final StoryTimeServiceAsync rpcService;
	private final HandlerManager eventBus;
	private final Display display;
	
	public GameInProgressRoomPresenter(StoryTimeServiceAsync rpcService, HandlerManager eventBus, Display display) {
