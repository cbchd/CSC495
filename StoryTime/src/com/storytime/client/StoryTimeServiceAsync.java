...
public interface StoryTimeServiceAsync {
    ...
    void hostLobbyRoom(String roomName, String theme,
    ...
    void updateLobbyRoomTimer(String roomName, int timer,
	    AsyncCallback<Void> callback);

    void leaveRoom(String roomName,
	    AsyncCallback<Void> callback);

    void sendRoomChatMessage(String roomName, String message,
	    AsyncCallback<Void> callback);
    ...
    void choosePhrase(String phrase, String roomName,
	    AsyncCallback<Void> callback);
